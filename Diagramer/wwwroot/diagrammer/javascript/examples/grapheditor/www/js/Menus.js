 ...
 * Sets the default font size.
 */
Menus.prototype.defaultMenuItems = ['file', 'edit', 'view', 'arrange', 'extras', 'help', 'profile'];
...
Menus.prototype.init = function()
{
	...
	this.put('formatBlock', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		...
		addItem('', 'h7').firstChild.nextSibling.innerHTML = '<h7 style="margin:0px;">' + mxResources.get('heading') + ' 7</h7>';
	...
	{
		this.addMenuItems(menu, ['save', 'export'], parent); //['new', 'open', '-', 'save', 'saveAs', '-', 'import', 'export', '-', 'pageSetup', 'print']
	})));
	...
	{
		this.addMenuItems(menu, ['copyConnect', 'collapseExpand', '-', 'editDiagram', '-', 'extractText']);
	})));
	this.put('help', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		this.addMenuItems(menu, ['about']); //['help', '-', 'about']
	})));
	//stepa
	this.put('profile', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		this.addMenuItems(menu, ['register', '-', 'login']);
...
Menus.prototype.createPopupMenu = function(menu, cell, evt)
{
	...
	this.addPopupMenuStepaItems(menu, cell, evt);
};
...
//Stepa
Menus.prototype.addPopupMenuStepaItems = function(menu, cell, evt)
{
	var graph = this.editorUi.editor.graph;


	this.addMenuItems(menu, ['register', '-', 'login'], null, evt);
