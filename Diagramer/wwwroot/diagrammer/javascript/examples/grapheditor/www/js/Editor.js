 ...
 */
Editor = function(chromeless, themes, model, graph, editable, socket)
{
 ...
 * Sets the XML node for the current diagram.
 */
Editor.prototype.createGraph = function(themes, model,socket)
{
	var graph = new Graph(null, model, null, null, themes,socket);
